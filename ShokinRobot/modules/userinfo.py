...
import ShokinRobot.modules.sql.userinfo_sql as sql
...
from ShokinRobot import telethn as ShokinTelethonClient
from ShokinRobot.__main__ import STATS, TOKEN, USER_INFO
from ShokinRobot.modules.disable import DisableAbleCommandHandler
from ShokinRobot.modules.helper_funcs.chat_status import sudo_plus
from ShokinRobot.modules.helper_funcs.extraction import extract_user
from ShokinRobot.modules.sql.afk_sql import check_afk_status, is_afk
from ShokinRobot.modules.sql.global_bans_sql import is_user_gbanned
from ShokinRobot.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/Shokinbotzone/26">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
