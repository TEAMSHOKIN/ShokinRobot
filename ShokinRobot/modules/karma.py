...
from ShokinRobot import OWNER_ID, pbot
from ShokinRobot.utils.admins import can_change_info
from ShokinRobot.utils.errors import capture_err
from ShokinRobot.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote = r"^((?i)\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤|💘|cool|good|👍|baby|Shokin|thank you|gud|thankyou|love|pro)$"
