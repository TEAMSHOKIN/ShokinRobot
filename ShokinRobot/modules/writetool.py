...
from ShokinRobot import BOT_NAME, BOT_USERNAME
from ShokinRobot import pbot as Shokin


@Shokin.on_message(filters.command("write"))
async def handwrite(_, message: Message):
    if not message.reply_to_message:
        text = message.text.split(None, 1)[1]
        m = await Shokin.send_message(
