...
# from ShokinRobot.modules.sql import warns_sql as warnssql
import ShokinRobot.modules.sql.blacklist_sql as blacklistsql

# from ShokinRobot.modules.sql import cust_filters_sql as filtersql
# import ShokinRobot.modules.sql.welcome_sql as welcsql
import ShokinRobot.modules.sql.locks_sql as locksql
import ShokinRobot.modules.sql.notes_sql as sql

# from ShokinRobot.modules.rules import get_rules
import ShokinRobot.modules.sql.rules_sql as rulessql
from ShokinRobot import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from ShokinRobot.__main__ import DATA_IMPORT
from ShokinRobot.modules.connection import connected
from ShokinRobot.modules.helper_funcs.alternate import typing_action
from ShokinRobot.modules.helper_funcs.chat_status import user_admin
from ShokinRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("ShokinRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("ShokinRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `ShokinRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("ShokinRobot{}.backup".format(chat_id))  # Cleaning file
