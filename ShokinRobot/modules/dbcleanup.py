...
import ShokinRobot.modules.sql.global_bans_sql as gban_sql
import ShokinRobot.modules.sql.users_sql as user_sql
from ShokinRobot import DEV_USERS, OWNER_ID, dispatcher
